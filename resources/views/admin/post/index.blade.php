      ...
      <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('post.create') }}" class="btn btn-primary btn-sm">Добавить пост</a>
                </div>
            </div>
            <!-- /.card-header -->
                ...
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('post.destroy', [$post->id]) }}" class="mr-1 d-inline-block" method="POST">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm "><i class="fas fa-trash"></i></button>
                            </form>
                            <a href="{{  route('single',['slug' => $post->slug])  }}" class="btn btn-success btn-sm mr-1"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                @endforeach
